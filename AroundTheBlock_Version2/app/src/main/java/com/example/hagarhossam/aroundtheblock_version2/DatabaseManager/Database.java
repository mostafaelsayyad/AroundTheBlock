...
public class Database {
            ...
            public void run() {
                try {
                    ...
                    RequestBody body = new FormEncodingBuilder()
                            ...
                            .add("name", name)
                            .build();
                    Request request = new Request.Builder().url("http://10.0.2.2/AroundTheBlock/sign_up.php").post(body).build();
    ...
    ///////////////////////////////////////  SIGN IN  /////////////////////////////////////////////////
    public ArrayList<ArrayList<String>> SignIn(final String email, final String password)
    {
        Thread thread = new Thread(new Runnable(){
            @Override
            public void run() {
                try {
                    ...
                    RequestBody body = new FormEncodingBuilder()
                            ...
                            .add("password", password)
                            .build();
                    Request request = new Request.Builder().url("http://10.0.2.2/AroundTheBlock/sign_in.php").post(body).build();
                    ...
                    System.out.println("data hyaa fil users  "+jsonData);
